...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update = $pdo->prepare('UPDATE Content SET title=?, description=?, status_id=?, deadline=?, updated_at=CURRENT_TIMESTAMP WHERE content_id=?');
    $update->execute([$title, $description, $status_id, $deadline, $id]);
